...
void
DiffusionEstimateNoiseVarianceFromTensorsImageFilter< TInputImage >
...
::ComputeInitialOutputFromDTI()
{
    ...
    using MaskRegionIteratorType = itk::ImageRegionIterator <OutputImageType>;
    using InputRegionIteratorType = itk::ImageRegionConstIterator <InputImageType>;
...
{
    using MaskRegionConstIteratorType = itk::ImageRegionConstIterator <OutputImageType>;
    using RegionConstIteratorType = itk::ImageRegionConstIterator <InputImageType>;
...
{
    using MaskRegionIteratorType = itk::ImageRegionConstIterator <OutputImageType>;
    using PValRegionIteratorType = itk::ImageRegionIterator < itk::Image <double,3> >;
    using RegionConstIteratorType = itk::ImageRegionConstIterator <InputImageType>;
...
{
    using MaskRegionIteratorType = itk::ImageRegionIterator <OutputImageType>;
    using PValRegionIteratorType = itk::ImageRegionConstIterator < itk::Image <double,3> >;
