...
class DiffusionEstimateNoiseVarianceFromTensorsImageFilter :
        public anima::NumberedThreadImageToImageFilter < TInputImage, itk::Image<unsigned char,3> >
{
public:
    /** Standard class typedefs. */
    using Self = DiffusionEstimateNoiseVarianceFromTensorsImageFilter;
    ...
    using Superclass = anima::NumberedThreadImageToImageFilter <TInputImage, TOutputImage>;
    ...
    itkTypeMacro(DiffusionEstimateNoiseVarianceFromTensorsImageFilter, anima::NumberedThreadImageToImageFilter)
...
protected:
DiffusionEstimateNoiseVarianceFromTensorsImageFilter()
        : Superclass()
    {
        m_NumberOfCoils = 1;
    ...
    virtual ~DiffusionEstimateNoiseVarianceFromTensorsImageFilter() {}
...
private:
    ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionEstimateNoiseVarianceFromTensorsImageFilter);
...
#include "animaDiffusionEstimateNoiseVarianceFromTensorsImageFilter.hxx"
