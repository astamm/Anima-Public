...
void LowMemoryLocalPatchMeanDistanceBridge::SetComputationMask(std::string &cMask)
{
...
void LowMemoryLocalPatchMeanDistanceBridge::Update(int specificSplitToDo, bool genOutputDescriptionData)
{
...
void LowMemoryLocalPatchMeanDistanceBridge::BuildAndWrite(OutputImageType *tmpIm, std::string resName,
