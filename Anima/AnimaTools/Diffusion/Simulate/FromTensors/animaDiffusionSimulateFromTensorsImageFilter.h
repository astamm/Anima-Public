...
class DiffusionSimulateFromTensorsImageFilter :
        public itk::ImageToImageFilter < itk::VectorImage<PixelScalarType,3>, itk::VectorImage<PixelScalarType,3> >
{
public:
    /** Standard class typedefs. */
    using Self = DiffusionSimulateFromTensorsImageFilter<PixelScalarType>;
    ...
    itkTypeMacro(DiffusionSimulateFromTensorsImageFilter, ImageToImageFilter);
...
protected:
    DiffusionSimulateFromTensorsImageFilter()
        : Superclass()
    {
        m_BValuesList.clear();
    ...
    virtual ~DiffusionSimulateFromTensorsImageFilter() {}
...
private:
    ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionSimulateFromTensorsImageFilter);
...
#include "animaDiffusionSimulateFromTensorsImageFilter.hxx"
