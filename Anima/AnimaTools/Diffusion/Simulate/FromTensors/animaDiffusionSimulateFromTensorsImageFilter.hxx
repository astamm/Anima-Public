#pragma once
#include "animaDiffusionSimulateFromTensorsImageFilter.h"
...
void
DiffusionSimulateFromTensorsImageFilter<PixelScalarType>
...
::DynamicThreadedGenerateData(const OutputImageRegionType &outputRegionForThread)
{
    ...
    using S0ImageIteratorType = itk::ImageRegionIterator <S0ImageType>;
...
template <class PixelScalarType>
typename DiffusionSimulateFromTensorsImageFilter<PixelScalarType>::Image4DType *
DiffusionSimulateFromTensorsImageFilter<PixelScalarType>
::GetOutputAs4DImage()
{
    this->Update();
    ...
    using OutImageIteratorType = itk::ImageRegionConstIterator <OutputImageType>;
    using Image4DIteratorType = itk::ImageRegionIterator <Image4DType>;
