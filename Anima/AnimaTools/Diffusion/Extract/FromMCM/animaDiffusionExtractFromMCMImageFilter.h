...
class DiffusionExtractFromMCMImageFilter :
public itk::ImageToImageFilter< anima::MCMImage <TPixelType, 3>, itk::Image<TPixelType, 3> >
{
public:
    /** Standard class typedefs */
    using Self = DiffusionExtractFromMCMImageFilter;
    ...
    itkTypeMacro(DiffusionExtractFromMCMImageFilter, itk::ImageToImageFilter);
...
protected:
    DiffusionExtractFromMCMImageFilter ()
    {
    ...
    virtual ~DiffusionExtractFromMCMImageFilter () {}
...
private:
    ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionExtractFromMCMImageFilter);
...
#include "animaDiffusionExtractFromMCMImageFilter.hxx"
