...
namespace anima
{
/** \class DiffusionExtractFromTensorsImageFilter
...
public:
    ...
    using Self = DiffusionExtractFromTensorsImageFilter;
    ...
    itkTypeMacro(DiffusionExtractFromTensorsImageFilter, anima::NumberedThreadImageToImageFilter);
...
protected:
    DiffusionExtractFromTensorsImageFilter();
    virtual ~DiffusionExtractFromTensorsImageFilter() {}

    void DynamicThreadedGenerateData(const OutputImageRegionType& outputRegionForThread) ITK_OVERRIDE;

private:
    ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionExtractFromTensorsImageFilter);
...
#include "animaDiffusionExtractFromTensorsImageFilter.hxx"
