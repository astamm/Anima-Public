...
int main(int ac, const char** av)
{
    ...
    using MatrixTransformPointer = MatrixTransformType::Pointer;
    ...
    using TensorImageType = itk::VectorImage<double, 3>;
    using OutputsImageType = itk::Image<double, 3>;

    using FilterType = anima::DiffusionExtractFromTensorsImageFilter<3>;
