#pragma once
#include "animaDiffusionExtractFromTensorsImageFilter.h"
...
DiffusionExtractFromTensorsImageFilter < ImageDimension >::DiffusionExtractFromTensorsImageFilter() :
    Superclass()
{
...
DiffusionExtractFromTensorsImageFilter< ImageDimension >::MakeOutput(itk::ProcessObject::DataObjectPointerArraySizeType idx)
{
...
template <unsigned int ImageDimension>
void
DiffusionExtractFromTensorsImageFilter< ImageDimension >::SetAnglesMatrix(vnl_matrix <double> &affMatrix)
{
...
template <unsigned int ImageDimension>
void
DiffusionExtractFromTensorsImageFilter< ImageDimension >
::DynamicThreadedGenerateData(const OutputImageRegionType& outputRegionForThread)
{
    ...
    using TensorSymMatrixType = vnl_matrix<double>;
    using EigenVectorType = itk::Vector<double, 3>;
