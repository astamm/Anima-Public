...
{
    using ImageType = anima::MCMImage <double,3>;
    using ImageReaderType = anima::MCMFileReader <double,3>;
    using ImageWriterType = anima::MCMFileWriter <double,3>;
    ...
    using GeomImageType = itk::Image <unsigned char, 3>;
    using GeomReaderType = itk::ImageFileReader <GeomImageType>;
    ...
    using MCMImageType = anima::MCMImage <double,3>;
