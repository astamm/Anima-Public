#include "animaDiffusionAverageODFImagesImageFilter.h"
...
namespace anima
{
    ...
    void DiffusionAverageODFImagesImageFilter::AddWeightImage(const unsigned int i, const WeightImagePointer &weightImage)
    {
    ...
    void DiffusionAverageODFImagesImageFilter::BeforeThreadedGenerateData()
    {
    ...
    void DiffusionAverageODFImagesImageFilter::DynamicThreadedGenerateData(const OutputImageRegionType &outputRegionForThread)
    {
    ...
    void DiffusionAverageODFImagesImageFilter::AfterThreadedGenerateData()
    {
        delete m_ODFSHBasis;
    }

    void DiffusionAverageODFImagesImageFilter::DiscretizeODF(const InputPixelType &modelValue, VectorType &odf)
    {
        unsigned int k = 0;
        double deltaPhi = 2.0 * M_PI / (static_cast<double>(m_NbSamplesPhi) - 1.0);
        double deltaTheta = M_PI / (static_cast<double>(m_NbSamplesTheta) - 1.0);
    ...
    DiffusionAverageODFImagesImageFilter::VectorType DiffusionAverageODFImagesImageFilter::GetSquareRootODFCoef(const VectorType &odf)
    {
    ...
    DiffusionAverageODFImagesImageFilter::OutputPixelType DiffusionAverageODFImagesImageFilter::GetSquareODFCoef(const VectorType &odf)
    {
    ...
    void DiffusionAverageODFImagesImageFilter::GetAverageHisto(const HistoArrayType &coefs, const VectorType &weightValues, OutputPixelType &resCoef)
    {
