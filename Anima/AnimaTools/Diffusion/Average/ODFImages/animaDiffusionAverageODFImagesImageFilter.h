...
namespace anima
{
    class DiffusionAverageODFImagesImageFilter : public anima::NumberedThreadImageToImageFilter<itk::VectorImage<float, 3>, itk::VectorImage<float, 3>>
    {
    public:
        using Self = DiffusionAverageODFImagesImageFilter;
        ...
        itkTypeMacro(DiffusionAverageODFImagesImageFilter, anima::NumberedThreadImageToImageFilter);
    ...
    protected:
        DiffusionAverageODFImagesImageFilter() : Superclass()
        {
            m_NbSamplesTheta = 10;
        ...
        virtual ~DiffusionAverageODFImagesImageFilter() {}
    ...
    private:
        ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionAverageODFImagesImageFilter);
