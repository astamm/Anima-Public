#pragma once
#include "animaDiffusionAverageAnisotropicCompartmentsImageFilter.h"
...
namespace anima
{
    ...
    void
    DiffusionAverageAnisotropicCompartmentsImageFilter<TPixelType>::GenerateOutputInformation()
    {
        //-------------------------------
    ...
    template <class TPixelType>
    void
    DiffusionAverageAnisotropicCompartmentsImageFilter<TPixelType>::BeforeThreadedGenerateData()
    {
    ...
    template <class TPixelType>
    void
    DiffusionAverageAnisotropicCompartmentsImageFilter<TPixelType>::DynamicThreadedGenerateData(const InputRegionType &region)
    {
