#include "animaDiffusionAverageODFImageFilter.h"
...
namespace anima
{
    ...
    void DiffusionAverageODFImageFilter::AddWeightImage(const unsigned int i, const WeightImagePointer &weightImage)
    {
    ...
    void DiffusionAverageODFImageFilter::BeforeThreadedGenerateData()
    {
    ...
    void DiffusionAverageODFImageFilter::DynamicThreadedGenerateData(const OutputImageRegionType &outputRegionForThread)
    {
    ...
    void DiffusionAverageODFImageFilter::AfterThreadedGenerateData()
    {
        delete m_ODFSHBasis;
    }

    void DiffusionAverageODFImageFilter::DiscretizeODF(const InputPixelType &modelValue, VectorType &odf)
    {
        unsigned int k = 0;
        double deltaPhi = 2.0 * M_PI / (static_cast<double>(m_NbSamplesPhi) - 1.0);
        double deltaTheta = M_PI / (static_cast<double>(m_NbSamplesTheta) - 1.0);
    ...
    DiffusionAverageODFImageFilter::VectorType DiffusionAverageODFImageFilter::GetSquareRootODFCoef(const VectorType &odf)
    {
    ...
    DiffusionAverageODFImageFilter::OutputPixelType DiffusionAverageODFImageFilter::GetSquareODFCoef(const VectorType &odf)
    {
    ...
    void DiffusionAverageODFImageFilter::GetAverageHisto(const HistoArrayType &coefs, const VectorType &weightValues, OutputPixelType &resCoef)
    {
