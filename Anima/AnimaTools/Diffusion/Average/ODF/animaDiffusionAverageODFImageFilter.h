...
namespace anima
{
    class DiffusionAverageODFImageFilter : public anima::NumberedThreadImageToImageFilter<itk::VectorImage<float, 3>, itk::VectorImage<float, 3>>
    {
    public:
        using Self = DiffusionAverageODFImageFilter;
        ...
        itkTypeMacro(DiffusionAverageODFImageFilter, anima::NumberedThreadImageToImageFilter);
    ...
    protected:
        DiffusionAverageODFImageFilter() : Superclass()
        {
            m_NbSamplesTheta = 10;
        ...
        virtual ~DiffusionAverageODFImageFilter() {}
    ...
    private:
        ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionAverageODFImageFilter);
