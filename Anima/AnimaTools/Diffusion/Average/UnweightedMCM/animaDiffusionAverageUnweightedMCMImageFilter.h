...
public:
    ...
    itkTypeMacro(DiffusionAverageUnweightedMCMImageFilter, ImageToImageFilter);
...
protected:
    DiffusionAverageUnweightedMCMImageFilter() {m_DDIAveragingMethod = 3;}
    virtual ~DiffusionAverageUnweightedMCMImageFilter() {}
...
private:
    ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionAverageUnweightedMCMImageFilter);
...
#include "animaDiffusionAverageUnweightedMCMImageFilter.hxx"
