#pragma once
#include "animaDiffusionAverageWeightedMCMImageFilter.h"
...
template <class PixelScalarType> const double DiffusionAverageWeightedMCMImageFilter<PixelScalarType>::m_ZeroThreshold = 1e-6;

template <class PixelScalarType>
void
DiffusionAverageWeightedMCMImageFilter<PixelScalarType>
...
::DynamicThreadedGenerateData(const OutputImageRegionType &outputRegionForThread)
{
    ...
    using MoseImageIteratorType = itk::ImageRegionIterator <MoseImageType>;
    MoseImageIteratorType moseIterator(m_MoseMap,outputRegionForThread);
    
    using ScalarImageIteratorType = itk::ImageRegionIterator <ScalarImageType>;
...
::AfterThreadedGenerateData()
{
    ...
    using ImageSimplifierType = anima::MCMImageSimplifier <PixelScalarType>;
...
template <class PixelScalarType>
typename DiffusionAverageWeightedMCMImageFilter<PixelScalarType>::WeightDataType
DiffusionAverageWeightedMCMImageFilter<PixelScalarType>
