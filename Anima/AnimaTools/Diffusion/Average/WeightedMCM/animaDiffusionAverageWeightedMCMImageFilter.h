...
public:
    ...
    itkTypeMacro(DiffusionAverageWeightedMCMImageFilter, anima::NumberedThreadImageToImageFilter);
    ...
    using EigenAnalysisType = itk::SymmetricEigenAnalysis <MatrixType,VectorType,MatrixType>;
...
protected:
    DiffusionAverageWeightedMCMImageFilter()
    : Superclass()
    {
    ...
    virtual ~DiffusionAverageWeightedMCMImageFilter() {}
...
private:
    ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionAverageWeightedMCMImageFilter);
...
#include "animaDiffusionAverageWeightedMCMImageFilter.hxx"
