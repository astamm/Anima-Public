#include "animaDiffusionAverageMCMImagesImageFilter.h"
...
int main(int argc, char **argv)
{
    ...
    anima::DiffusionAverageMCMImagesImageFilter <double>::Pointer mainFilter = anima::DiffusionAverageMCMImagesImageFilter <double>::New();

    using MCMReaderType = anima::MCMFileReader <double,3>;
    using MCMWriterType = anima::MCMFileWriter <double, 3>;
    using ImageType = itk::VectorImage<double, 3>;
    using MaskImageType = anima::DiffusionAverageMCMImagesImageFilter <double>::MaskImageType;
