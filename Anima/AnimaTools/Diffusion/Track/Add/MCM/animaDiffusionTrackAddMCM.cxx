...
{   
    ...
    using IndexType = ModelImageType::IndexType;
    using PointType = ModelImageType::PointType;
    
    using CompartmentType = anima::BaseCompartment;
    using CompartmentPointer = CompartmentType::Pointer;
...
using ThreaderArguments = struct
{
    vtkPolyData *tracks;
