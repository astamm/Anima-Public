...
int main(int argc,  char*  argv[])
{
    ...
    using MainFilterType = anima::DTIProbabilisticTractographyImageFilter;
    using InputModelImageType = MainFilterType::InputModelImageType;
    using MaskImageType = MainFilterType::MaskImageType;
    using Vector3DType = MainFilterType::Vector3DType;
    
    MainFilterType::Pointer dtiTracker = MainFilterType::New();
    
    // Load model image
    using LogFilterType = anima::LogTensorImageFilter <double, 3>;
    ...
    using ScalarImageType = MainFilterType::ScalarImageType;
