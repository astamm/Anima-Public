...
int main(int argc,  char*  argv[])
{
    ...
    using MainFilterType = anima::dtiTractographyImageFilter;
    using DTIImageType = MainFilterType::ModelImageType;
    using MaskImageType = MainFilterType::MaskImageType;

    MainFilterType::Pointer dtiTracker = MainFilterType::New();

    using LogTensorFilterType = anima::LogTensorImageFilter <DTIImageType::IOPixelType,DTIImageType::ImageDimension>;
