...
class DiffusionEstimateMCMWithLowMemoryBridge
{
public:
    ...
    DiffusionEstimateMCMWithLowMemoryBridge();
    ~DiffusionEstimateMCMWithLowMemoryBridge();

    std::string GetNameOfClass() {return "DiffusionEstimateMCMWithLowMemoryBridge";}
