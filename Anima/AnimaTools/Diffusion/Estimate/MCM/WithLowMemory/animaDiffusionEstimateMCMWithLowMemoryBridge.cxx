#include "animaDiffusionEstimateMCMWithLowMemoryBridge.h"
...
DiffusionEstimateMCMWithLowMemoryBridge::DiffusionEstimateMCMWithLowMemoryBridge()
{
    m_NbSplits = 2;
...
void DiffusionEstimateMCMWithLowMemoryBridge::SetComputationMask(std::string &cMask)
{
...
void DiffusionEstimateMCMWithLowMemoryBridge::SetInputMoseName(std::string &fileName)
{
    if (!m_InputMoseImage)
...
void DiffusionEstimateMCMWithLowMemoryBridge::Update(int specificSplitToDo, bool genOutputDescriptionData)
{
    if (!m_ComputationMask)
...
void DiffusionEstimateMCMWithLowMemoryBridge::BuildAndWriteMCM(OutputImageType *tmpIm, std::string resName,
