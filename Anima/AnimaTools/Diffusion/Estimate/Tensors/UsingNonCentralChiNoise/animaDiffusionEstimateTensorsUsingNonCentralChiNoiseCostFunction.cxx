...
namespace anima
{
    DiffusionEstimateTensorsUsingNonCentralChiNoiseCostFunction::DiffusionEstimateTensorsUsingNonCentralChiNoiseCostFunction()
    {
        m_RawSignal.clear();
    ...
    DiffusionEstimateTensorsUsingNonCentralChiNoiseCostFunction::MeasureType DiffusionEstimateTensorsUsingNonCentralChiNoiseCostFunction::GetValue(const ParametersType & parameters) const
    {
    ...
    void DiffusionEstimateTensorsUsingNonCentralChiNoiseCostFunction::GetDerivative(const ParametersType & parameters, DerivativeType & derivative) const
    {
