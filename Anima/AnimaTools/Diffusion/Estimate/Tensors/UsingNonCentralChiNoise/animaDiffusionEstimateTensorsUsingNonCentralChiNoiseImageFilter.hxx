#pragma once
#include "animaDiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter.h"
#include "animaDiffusionEstimateTensorsUsingNonCentralChiNoiseCostFunction.h"

#include <animaBesselFunctions.h>
#include <animaDiffusionEstimateNoiseVarianceFromTensorsImageFilter.h>
...
void
DiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter<PixelScalarType>
...
{
    using BackgroundVarianceFilterType = anima::DiffusionEstimateNoiseVarianceFromTensorsImageFilter<InputImageType>;
...
{
    using ImageIteratorType = itk::ImageRegionConstIterator <InputImageType>;
    using EffImageIteratorType = itk::ImageRegionIterator <InputImageType>;
    ...
    using DTIImageIteratorType = itk::ImageRegionConstIterator <OutputImageType>;
    ...
    anima::DiffusionEstimateTensorsUsingNonCentralChiNoiseCostFunction::Pointer cost = anima::DiffusionEstimateTensorsUsingNonCentralChiNoiseCostFunction::New();
