...
class DiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter :
    public anima::MaskedImageToImageFilter< itk::Image<PixelScalarType,3>, itk::VectorImage<PixelScalarType,3> >
{
public:
    /** Standard class typedefs. */
    using Self = DiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter<PixelScalarType>;
    using InputImageType = itk::Image<PixelScalarType,3>;
    using OutputImageType = itk::VectorImage<PixelScalarType,3>;
    ...
    itkTypeMacro(DiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter, MaskedImageToImageFilter);
...
protected:
    DiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter()
        : Superclass()
    {
        m_BValuesList.clear();
    ...
    virtual ~DiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter() {}
...
private:
    ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter);
...
#include "animaDiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter.hxx"
