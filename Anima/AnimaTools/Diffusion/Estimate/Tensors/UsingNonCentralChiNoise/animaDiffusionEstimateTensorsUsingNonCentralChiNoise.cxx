...
int main(int argc,  char **argv)
{
    ...
    using FilterType = anima::DiffusionEstimateTensorsUsingNonCentralChiNoiseImageFilter<double>;
    using InputImageType = FilterType::InputImageType;
    using VectorImageType = FilterType::OutputImageType;

    using InputImageReaderType = itk::ImageFileReader <InputImageType>;
    using InputImageWriterType = itk::ImageFileWriter <InputImageType>;
    using VectorImageReaderType = itk::ImageFileReader <VectorImageType>;
    using VectorImageWriterType = itk::ImageFileWriter <VectorImageType>;
