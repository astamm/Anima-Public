...
#include "animaDiffusionEstimateTODImageFilter.h"
...
namespace anima
{
    ...
    void
    DiffusionEstimateTODImageFilter<ScalarType>::BeforeThreadedGenerateData()
    {
    ...
    template <typename ScalarType>
    void
    DiffusionEstimateTODImageFilter<ScalarType>::ComputeCoefs()
    {
    ...
    template <typename ScalarType>
    void
    DiffusionEstimateTODImageFilter<ScalarType>::DynamicThreadedGenerateData(const DiffusionEstimateTODImageFilter::OutputImageRegionType &outputRegionForThread)
    {
        OutputImageType *output = this->GetOutput();
    ...
    template <typename ScalarType>
    void
    DiffusionEstimateTODImageFilter<ScalarType>::GetMainDirections(DirVectorType inDirs, DirVectorType &mainDirs)
    {
    ...
    template <typename ScalarType>
    typename DiffusionEstimateTODImageFilter<ScalarType>::DirType
    DiffusionEstimateTODImageFilter<ScalarType>::GetNewClusterAverage(int numCluster, DirVectorType &indirs, std::vector<int> &cluster)
    {
        DirType sum, sumNorm;
        DirVectorType dirs;
        dirs = indirs;
    ...
    template <typename ScalarType>
    double
    DiffusionEstimateTODImageFilter<ScalarType>::GetEuclideanDistance(DirType dir1, DirType dir2)
    {
    ...
    template <typename ScalarType>
    void
    DiffusionEstimateTODImageFilter<ScalarType>::GetSHCoef(DirType tmpDir, OutputImagePixelType &coefs)
    {
    ...
    template <typename ScalarType>
    void
    DiffusionEstimateTODImageFilter<ScalarType>::AverageODFs(std::vector<OutputImagePixelType> &vecCoefs, OutputImagePixelType &resOdf)
    {
    ...
    template <typename ScalarType>
    void
    DiffusionEstimateTODImageFilter<ScalarType>::PrecomputeSH()
    {
        int k = 0;
    ...
    template <typename ScalarType>
    void
    DiffusionEstimateTODImageFilter<ScalarType>::DiscretizeODF(OutputImagePixelType ODFCoefs, std::vector<double> &ODFDiscret)
    {
        int k = 0;
        double resVal2 = 0;
    ...
    template <typename ScalarType>
    typename DiffusionEstimateTODImageFilter<ScalarType>::OutputImagePixelType
    DiffusionEstimateTODImageFilter<ScalarType>::GetSquareRootODF(std::vector<double> ODFDiscret)
    {
    ...
    template <typename ScalarType>
    typename DiffusionEstimateTODImageFilter<ScalarType>::OutputImagePixelType
    DiffusionEstimateTODImageFilter<ScalarType>::GetSquareODF(std::vector<double> ODFDiscret)
    {
        vnl_matrix<double> Odf(m_NbSample, 1);
        vnl_matrix<double> Coef(m_VectorLength, 1);
    ...
    template <typename ScalarType>
    void
    DiffusionEstimateTODImageFilter<ScalarType>::GetAverageCoefs(std::vector<OutputImagePixelType> &vecCoefs, OutputImagePixelType &avgCoef)
    {
    ...
    template <typename ScalarType>
    typename DiffusionEstimateTODImageFilter<ScalarType>::DirType
    DiffusionEstimateTODImageFilter<ScalarType>::GetFiberDirection(int index, FiberType &fiber)
    {
        DirType resDir;
    ...
    template <typename ScalarType>
    typename DiffusionEstimateTODImageFilter<ScalarType>::PointType
    DiffusionEstimateTODImageFilter<ScalarType>::GetCenterVoxel(int index, FiberType &fiber)
    {
        PointType resPoint;
        for (int i = 0; i < 3; i++)
        {
    ...
    template <typename ScalarType>
    typename DiffusionEstimateTODImageFilter<ScalarType>::FiberType
    DiffusionEstimateTODImageFilter<ScalarType>::ReadFiber(vtkIdType numberOfPoints, const vtkIdType *indices, vtkPoints *points)
    {
        FiberType fiber;
