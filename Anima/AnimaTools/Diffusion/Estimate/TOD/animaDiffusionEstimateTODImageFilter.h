...
namespace anima
{
    ...
    class DiffusionEstimateTODImageFilter : public anima::NumberedThreadImageToImageFilter<itk::Image<ScalarType, 3>, itk::VectorImage<ScalarType, 3>>
    {
    public:
        /** Standard class typedefs. */
        using Self = DiffusionEstimateTODImageFilter;
        ...
        itkTypeMacro(DiffusionEstimateTODImageFilter, anima::NumberedThreadImageToImageFilter);
    ...
    protected:
        DiffusionEstimateTODImageFilter() {}

        virtual ~DiffusionEstimateTODImageFilter() {}
    ...
    private:
        ITK_DISALLOW_COPY_AND_ASSIGN(DiffusionEstimateTODImageFilter);
...
#include "animaDiffusionEstimateTODImageFilter.hxx"
