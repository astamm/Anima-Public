...
int main(int argc,  char **argv)
{
    ...
    using FilterType = anima::DiffusionEstimateNoiseVarianceFromTensorsImageFilter <InputImageType>;
    using VectorImageType = FilterType::VectorImageType;
    using MaskImageType = FilterType::OutputImageType;
    ...
    using OutputImageWriterType = itk::ImageFileWriter <MaskImageType>;
