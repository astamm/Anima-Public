...
StickCompartment::ListType &StickCompartment::GetPriorDerivativeVector()
{
    ...
    if (m_EstimateAxialDiffusivity)
    {
        ...
        betaPriorDerivative *= m_FractionalAnisotropyPrior.GetDensityDerivative(faValue);
        ...
        double lambdaPriorDerivative = m_MeanDiffusivityPrior.GetDensityDerivative(mdValue) / 3.0;
