...
namespace anima
{
    ...
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::AddGradientDirection(unsigned int i, GradientType &grad)
    {
    ...
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::GetNewMCMCreatorInstance()
    {
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::GenerateOutputInformation()
    {
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::WriteMCMOutput(std::string fileName)
    {
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::CheckComputationMask()
    {
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::BeforeThreadedGenerateData()
    {
        ...
        case CHARMED:
            this->ComputeCHARMEDCoarseGrids();
            break;
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::InitializeDictionary()
    {
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::OptimizeNonIsotropicCompartments(MCMPointer &mcmValue, unsigned int currentNumberOfCompartments,
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::EstimateFreeWaterModel(MCMPointer &mcmValue, std::vector<double> &observedSignals, itk::ThreadIdType threadId,
                                                                                     double &aiccValue, double &b0Value, double &sigmaSqValue)
    {
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::InitialOrientationsEstimation(MCMPointer &mcmValue, bool authorizedNegativeB0Value, unsigned int currentNumberOfCompartments,
                                                                                            std::vector<double> &observedSignals, itk::ThreadIdType threadId,
                                                                                            double &aiccValue, double &b0Value, double &sigmaSqValue)
    {
        b0Value = 0;
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::ModelEstimation(MCMPointer &mcmValue, bool authorizedNegativeB0Value, std::vector<double> &observedSignals, itk::ThreadIdType threadId,
                                                                              double &aiccValue, double &b0Value, double &sigmaSqValue)
    {
        ...
        case CHARMED:
            this->CHARMEDCoarseGridInitialization(mcmUpdateValue, cost, workVec, p);
            break;
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::ExtraAxonalAndKappaCoarseGridInitialization(MCMPointer &mcmUpdateValue, CostFunctionBasePointer &cost,
                                                                                                          MCMType::ListType &workVec, ParametersType &p)
    {
        unsigned int dimension = p.GetSize();
        double optNu = 0;
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::CHARMEDCoarseGridInitialization(MCMPointer &mcmUpdateValue, CostFunctionBasePointer &cost,
                                                                                              MCMType::ListType &workVec, ParametersType &p)
    {
        unsigned int dimension = p.GetSize();
        double optNu = 0;
        ...
        for (unsigned int j = 0; j < m_ValuesCoarseGrid[1].size(); ++j)
        {
            ...
            for (unsigned int k = 0; k < m_ValuesCoarseGrid[0].size(); ++k)
            {
                ...
                for (unsigned int i = numIsoCompartments; i < numCompartments; ++i)
                {
                    mcmUpdateValue->GetCompartment(i)->SetTissueRadius(tmpRadius);
                    mcmUpdateValue->GetCompartment(i)->SetExtraAxonalFraction(tmpNu);
                }
        ...
        for (unsigned int i = numIsoCompartments; i < numCompartments; ++i)
        {
            mcmUpdateValue->GetCompartment(i)->SetTissueRadius(optRadius);
            mcmUpdateValue->GetCompartment(i)->SetExtraAxonalFraction(optNu);
        }
    }
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::TensorCoarseGridInitialization(MCMPointer &mcmUpdateValue, CostFunctionBasePointer &cost,
                                                                                             MCMType::ListType &workVec, ParametersType &p)
    {
        unsigned int dimension = p.GetSize();
        unsigned int numIsoCompartments = mcmUpdateValue->GetNumberOfIsotropicCompartments();
    ...
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::CreateOptimizer(CostFunctionBasePointer &cost, itk::Array<double> &lowerBounds, itk::Array<double> &upperBounds)
    {
    ...
    template <class InputPixelType, class OutputPixelType>
    double
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::PerformSingleOptimization(ParametersType &p, CostFunctionBasePointer &cost, itk::Array<double> &lowerBounds, itk::Array<double> &upperBounds)
    {
        double costValue = this->GetCostValue(cost, p);
    ...
    template <class InputPixelType, class OutputPixelType>
    double
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::GetCostValue(CostFunctionBasePointer &cost, ParametersType &p)
    {
        if (m_Optimizer == "levenberg")
        {
            anima::MCMMultipleValuedCostFunction *costCast =
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::GetProfiledInformation(CostFunctionBasePointer &cost, MCMPointer &mcm, double &b0Value, double &sigmaSqValue)
    {
    ...
    template <class InputPixelType, class OutputPixelType>
    double
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::ComputeAICcValue(MCMPointer &mcmValue, double costValue)
    {
        ...
        double AICc = costValue + 2.0 * nbparams + 2.0 * nbparams * (nbparams + 1.0) / (m_NumberOfImages - nbparams - 1.0) + m_NumberOfImages * std::log(m_NumberOfImages / (m_NumberOfImages - nbparams - 1.0));
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::SparseInitializeSticks(MCMPointer &complexModel, bool authorizeNegativeB0Value, std::vector<double> &observedSignals,
    ...
    template <class InputPixelType, class OutputPixelType>
    void
    MCMEstimatorImageFilter<InputPixelType, OutputPixelType>::InitializeModelFromSimplifiedOne(MCMPointer &simplifiedModel, MCMPointer &complexModel)
    {
        // copy everything
        unsigned int numCompartments = complexModel->GetNumberOfCompartments();
