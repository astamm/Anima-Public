...
namespace anima
{
    ...
    class MCMEstimatorImageFilter : public anima::MaskedImageToImageFilter<itk::Image<InputPixelType, 3>, anima::MCMImage<OutputPixelType, 3>>
    {
    public:
    ...
    protected:
        ...
        //! Computes extra axonal and tissue radius coarse grids (used for CHARMED initialization)
        ...
        void CHARMEDCoarseGridInitialization(MCMPointer &mcmUpdateValue, CostFunctionBasePointer &cost,
                                             MCMType::ListType &workVec, ParametersType &p);
